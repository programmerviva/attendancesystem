...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] font-sans">
      ...
      <div className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className={`text-center transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-2xl md:text-3xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
            ...
            <div className="flex justify-center">
              <Link
                to="/login"
                className="group relative bg-gradient-to-r from-[#f97316] to-[#fb923c] text-white px-16 py-5 rounded-full text-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 w-full bg-transparent py-6">
