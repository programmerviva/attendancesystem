          ...
          <div className="relative px-8 pt-10 pb-8">
            ...
            <div className="flex justify-center mb-4">
              <button
                ...
                className={`px-4 py-2 rounded-l-xl ${mode === 'employee' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Employee
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-r-xl ${mode === 'admin' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Admin
              </button>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {mode === 'employee' && (
                <div className="text-xs text-orange-200 mb-2">
                  Note: If you do not receive an email, please contact admin to update your email
